...
import game.object.TargetingLaser;
...
public class Player extends CircleGameObject {
	...
	private final PlayerAttack[] linearattacks = { new PlayerAttack() {
		...
		@Override
		public void init() {
			l = new Laser(Player.this, Global.Dir.UP);
			EventHandler.add(new LaserAttackEvent(0, l, Player.this));
		...
		@Override
		public void init() {
			EventHandler.add(new BulletAttackEvent(Global.player_bullet_delay,
		...
		@Override
		public void init() {
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
			...
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP - .2f, Global.player_bullet_speed),
					Player.this, 0, 0));
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP + .2f, Global.player_bullet_speed),
			...
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP - .21f, Global.player_bullet_speed),
					Player.this, 0, 0));
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP + .21f, Global.player_bullet_speed),
			...
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP - .5f, Global.player_bullet_speed),
					Player.this, 0, 0));
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP + .5f, Global.player_bullet_speed),
			...
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP - .51f, Global.player_bullet_speed),
					Player.this, 0, 0));
			EventHandler.add(new BulletAttackEvent(
					Global.player_wtf_bullet_delay, new PlayerLinearBullet(
							Global.Dir.UP + .51f, Global.player_bullet_speed),
	...
	new PlayerAttack() {
		...
		protected void init() {
			...
			for (int i = 0; i < sideshooternum; i++) {
				...
				EventHandler.add(new BulletAttackEvent(
						Global.player_bullet_delay, new PlayerLinearBullet(
								Global.Dir.UP, Global.player_bullet_speed),
						sideshooters.get(i)));
			}
			EventHandler.add(new BulletAttackEvent(Global.player_bullet_delay,
	...
	/**
	 * power level 8, testing auto targeting laser
	 */
	new PlayerAttack() {
		ArrayList<TargetingLaser> l;

		@Override
		protected void init() {
			l = new ArrayList<TargetingLaser>();
			int sideshooternum = 5;
			for (int i = 0; i < sideshooternum; i++) {
				sideshooters.add(new SideShooter(Player.this, 2.5f, 150,
						Global.Dir.PI2 / sideshooternum * i, -.001f));
				final int j = i;
				EventHandler.add(new Event(200 * i) {

					@Override
					public void run() {
						TargetingLaser tl = new TargetingLaser(sideshooters
								.get(j), Global.Dir.UP);
						l.add(tl);
						Game.addPlayerLaser(tl);
	...
	public class PlayerSeekerBullet extends SeekerBullet {
		...
		public PlayerSeekerBullet(float px, float py, float dir, float speed) {
			...
			size = Global.player_bullet_size;
			Game.addVisuals(new TrailVisual(this, 1, 1, 1, 0.5f,
					this.size / 2f, 1000));
		}
	...
	public class PlayerLaser extends Laser {
		...
		public PlayerLaser(CircleGameObject parent, float dir) {
			super(parent, dir);
		}
